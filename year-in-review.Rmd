...
#
# You ALSO need GITHUB_PAT setup in your environment. See https://github.com/r-lib/gh/blob/eecde016754be7769f6f401deb39cc90f3ac7cdd/R/gh_whoami.R for details.
```
...
library(jerichojars) # devtools::install_github("hrbrmstr/jerichojars") # implies rJava requirement
